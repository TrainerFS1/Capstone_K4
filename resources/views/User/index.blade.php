         ...
         <div class="container-fluid">
            <div class="card">
                <div class="card-header text-right">
                    <a href="{{ route('User-create') }}" class="btn btn-primary" role="button">Tambah Artikel</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                          @foreach ($Users as $User)
                            <tr>
                                <td> {{ $loop->index + 1 }}</td>
                                <td>
                                    <img src="{{ asset('storage/artikels/'.$artikel->gambar) }}" class="rounded" style="width: 100px">
                                </td>
